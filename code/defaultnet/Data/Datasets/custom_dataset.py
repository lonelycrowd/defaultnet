### This is not a real dataset, but the skeleton of any custom dataset you wish to use
...
class CustomDataset(Dataset):
    ...
    """
    def __init__(self,input_dimension, class_label_map=None, identify=None, img_transform=None, anno_transform=None, **kwargs):
